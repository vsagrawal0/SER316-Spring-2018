...
*/
	 ...
	 public int compareTo(Object o) {
		 ITask iTask = (ITask) o;
		 	if(getRate() > iTask.getRate())
				return 1;
			else if(getRate() < iTask.getRate())
				return -1;
			else 
				return 0;
	 }
