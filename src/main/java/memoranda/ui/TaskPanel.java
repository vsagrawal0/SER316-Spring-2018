...
import main.java.memoranda.TaskParameters;
...
//        CalendarDate ed = new CalendarDate((Date) dlg.endDate.getModel().getValue());
        ...
        TaskParameters task = new TaskParameters(sd, ed, dlg.todoField.getText());
        ...
        ITask newTask = CurrentProject.getTaskList().createTask(task);
